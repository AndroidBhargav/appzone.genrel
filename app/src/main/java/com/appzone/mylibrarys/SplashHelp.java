...
import static com.appzone.mylibrarys.Util.DEc;
...
public class SplashHelp extends AppCompatActivity {
    ...
    public static void splash_next(String packageName, String versionCode, Context context, Intent intent) {
        ...
        asyncHttpClient.addHeader(Util.DEc(Util.pizzuhead), DEc(Util.pizzudians));
        asyncHttpClient.get(Util.DEc(Util.pizzuli) + packageName, new JsonHttpResponseHandler() {
            @Override
            public void onStart() {
                super.onStart();
            }
